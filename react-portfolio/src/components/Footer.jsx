                ...
                <div className="footer-grid">
                    <div className="footer-brand">
                        ...
                        <div className="social-links">
                            <a href="https://github.com/SHAHRIYARTAUFIK" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
                    ...
                    <div className="footer-col">
                        ...
                        <a href="https://github.com/SHAHRIYARTAUFIK" target="_blank" rel="noopener noreferrer">GitHub</a>
